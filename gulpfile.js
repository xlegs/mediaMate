...
var paths = {
  ...
  sass: [
    ...
    'bower_components/angular-tooltips/lib/'
  ],
...
gulp.task('copy:foundation', function(cb) {
  ...
  // Tooltip files
  gulp.src('bower_components/angular-tooltips/dist/*.css.min.map')
    .pipe(gulp.dest('build/assets/css/'))
  ;

  gulp.src('./bower_components/angular-tooltips/dist/*.js.map')
  .pipe(gulp.dest('./build/assets/js/'))
  ;
